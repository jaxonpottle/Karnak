...
export default function HomeScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: themeStyles.container.backgroundColor }]}>
      ...
      <Text style={[styles.title, { color: themeStyles.title.color }]}>Home</Text>
...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      <Button
        title="Start a New Car Process"
        onPress={() => navigation.navigate('NewCarProcess')}
      />
      <Button
        title="Find an Existing Car"
